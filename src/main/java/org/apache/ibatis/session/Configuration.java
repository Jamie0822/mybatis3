...
public class Configuration {
    ...
    /**
     * 解析 mybatis-config.xml 配置文件时 在解析 setting 节点后 再次解析并设置 logImpl
     */
    protected Class<? extends Log> logImpl;
    /**
     * 解析 mybatis-config.xml 配置文件时 在解析 setting 节点后 再次解析并设置 vfsImpl
     */
    ...
    /**
     * 该属性在 解析 mybatis-config.xml 配置文件的 properties 节点 时 设置
     */
    protected Properties variables = new Properties();
    protected ReflectorFactory reflectorFactory = new DefaultReflectorFactory();
    /**
     * 解析 mybatis-config.xml 配置文件的 objectFactory 节点 时 设置
     */
